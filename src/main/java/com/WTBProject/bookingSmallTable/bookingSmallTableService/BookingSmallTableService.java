package com.WTBProject.bookingSmallTable.bookingSmallTableService;
...
public class BookingSmallTableService {
    ...
    private final BookingSmallTableRepository bookingSmallTableRepository;
    ...
    public Long makeReservation(BookingSmallTableDTO bookingSmallTableDTO){
        ...
        eventPublisher.publishEvent(insertedSmallTableBooking);
